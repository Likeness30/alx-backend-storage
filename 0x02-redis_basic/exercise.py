...
def count_calls(method: Callable) -> Callable:
    '''It counts how many times methods of Cache class are called'''
...
def call_history(method: Callable) -> Callable:
    '''It stores the history of inputs and outputs for a particular function'''
    @wraps(method)
    def wrapper(self, *args, **kwargs):
        '''wrap the decorated function and return the wrapper'''
        input = str(args)
...
def replay(fn: Callable):
    '''It displays the history of calls of a particular function'''
    r = redis.Redis()
